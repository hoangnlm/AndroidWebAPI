...
import com.example.Hoang.myapplication.backend.lib.JSONException;
import com.example.Hoang.myapplication.backend.lib.JSONObject;
...
public class Login extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        resp.getWriter().println("Hay chuyen sang xai POST");
    }
